...
set "RESOLUTION=1500x1080"
set "SHORTCUT=C:\Users\tutot\Desktop\Orbit settings\Orbit settings\Windows tweaks\fortnite GameUserSettings\1080p.lnk"
:: ─────────────────────────────────────────────────────────────────────
