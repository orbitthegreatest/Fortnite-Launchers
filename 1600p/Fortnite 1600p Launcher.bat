...
set "RESOLUTION=2293x1440"
set "SHORTCUT=C:\Users\tutot\Desktop\Orbit settings\Orbit settings\Windows tweaks\fortnite GameUserSettings\1600p.lnk"
:: ─────────────────────────────────────────────────────────────────────
...
echo.
echo Fortnite 1600p launched successfully.
